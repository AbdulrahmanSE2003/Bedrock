        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {features.map((f, i) => (
            <motion.div
              ...
              className={`p-8 rounded-3xl border border-zinc-400/50 dark:border-zinc-900 bg-zinc-50/50 dark:bg-zinc-900/30 backdrop-blur-sm flex flex-col justify-between min-h-58 ${f.className} group`}
            >
